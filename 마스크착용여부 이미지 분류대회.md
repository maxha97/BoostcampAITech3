...
### Loss
- CrossEntropy Loss
<img src="https://latex.codecogs.com/svg.latex?\Large&space;x=\frac{\left( P,Q\right) =-p\left( x\right) \log Q\left( x\right) }{2a}" title="H\left( P,Q\right) =-p\left( x\right) \log Q\left( x\right)" />
$$
